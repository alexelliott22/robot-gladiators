...
var fightOrSkip = function() {
    ...
    if (promptFight === "skip") {
        ...
        //if yes, leave fight
        if(confirmSkip) {
            window.alert(playerInfo.name + " has decided to skip this fight. Godbye.");
...
var endGame = function() {
    ...
    if (playerInfo.health > 0) {
        window.alert ("Great job, you've survuved the game! You now have a score of " + playerInfo.money + ".");
    }
    else {
...
var playerInfo = {
    ...
    refillHealth: function() {
        if (this.money <= 7) {
            ...
            window.alert("You don't have enogh money.");
        }
    },
